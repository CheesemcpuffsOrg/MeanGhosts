...
public partial class @ControlScheme: IInputActionCollection2, IDisposable
{
    ...
    private List<ISoundDesignTestingActions> m_SoundDesignTestingActionsCallbackInterfaces = new List<ISoundDesignTestingActions>();
    ...
    public struct SoundDesignTestingActions
    {
        ...
        public void AddCallbacks(ISoundDesignTestingActions instance)
        {
            if (instance == null || m_Wrapper.m_SoundDesignTestingActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_SoundDesignTestingActionsCallbackInterfaces.Add(instance);
        ...
        private void UnregisterCallbacks(ISoundDesignTestingActions instance)
        {
            @one.started -= instance.OnOne;
            @one.performed -= instance.OnOne;
            @one.canceled -= instance.OnOne;
        ...
        public void RemoveCallbacks(ISoundDesignTestingActions instance)
        {
            if (m_Wrapper.m_SoundDesignTestingActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }

        public void SetCallbacks(ISoundDesignTestingActions instance)
        {
            foreach (var item in m_Wrapper.m_SoundDesignTestingActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_SoundDesignTestingActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
